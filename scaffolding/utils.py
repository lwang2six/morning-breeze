...
FIELD_OPTION_DEFAULT_FALSE = 'default=False'
FIELD_OPTION_DEFAULT_DATETIME_NOW = 'default=datetime.datetime.now'
FIELD_OPTION_DEFAULT_ZERO = 'default=0'
...
FIELD_OPTIONS_DEFAULT = (
    ...
    (FIELD_OPTION_CHOICES , 'choices'),
    (FIELD_OPTION_DEFAULT , 'default'),
    (FIELD_OPTION_DEFAULT_FALSE, 'default'),
    (FIELD_OPTION_DEFAULT_DATETIME_NOW , 'default'),
    (FIELD_OPTION_DEFAULT_ZERO , 'default'),
...
FIELD_OPTIONS_DEFAULT_SET = set([FIELD_OPTION_BLANK, FIELD_OPTION_CHOICES, 
                                 FIELD_OPTION_DEFAULT, FIELD_OPTION_DEFAULT_FALSE,
                                 FIELD_OPTION_DEFAULT_DATETIME_NOW, FIELD_OPTION_DEFAULT_ZERO,
...
FIELD_OPTIONS_BOOL_SET = set([FIELD_OPTION_DEFAULT_FALSE, FIELD_OPTION_EDITABLE, FIELD_OPTION_DEFAULT,
...
FIELD_OPTIONS_DATETIME_SET = set([FIELD_OPTION_BLANK, FIELD_OPTION_DEFAULT_DATETIME_NOW, FIELD_OPTION_DEFAULT,
                                  FIELD_OPTION_EDITABLE, FIELD_OPTION_HELP_TEXT, 
...
FIELD_OPTIONS_INTEGER_SET = set([FIELD_OPTION_BLANK, FIELD_OPTION_DEFAULT_ZERO, FIELD_OPTION_DEFAULT,
                                 FIELD_OPTION_EDITABLE, FIELD_OPTION_HELP_TEXT, 
                                 FIELD_OPTION_MAX_LENGTH, FIELD_OPTION_NULL, 
                                 FIELD_OPTION_RELATED_NAME, FIELD_OPTION_UNIQUE,
                                 FIELD_OPTION_VERBOSE_NAME])
