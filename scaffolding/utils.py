...
FIELD_OPTIONS_BOOL_SET = set(['default="False"', FIELD_OPTION_EDITABLE,
...
FIELD_OPTIONS_DATETIME_SET = set([FIELD_OPTION_BLANK, 'default=datetime.datetime.now',
                                  FIELD_OPTION_EDITABLE, FIELD_OPTION_HELP_TEXT, 
...
FIELD_OPTIONS_FILE_SET = set([FIELD_OPTION_BLANK, FIELD_OPTION_DEFAULT,
                              FIELD_OPTION_EDITABLE, FIELD_OPTION_HELP_TEXT, 
                              'max_length=255', FIELD_OPTION_NULL, 
                              FIELD_OPTION_RELATED_NAME, FIELD_OPTION_UNIQUE,
                              FIELD_OPTION_VERBOSE_NAME])
...
FIELD_OPTIONS_INTEGER_SET = set([FIELD_OPTION_BLANK, 'default=0',
                                 FIELD_OPTION_EDITABLE, FIELD_OPTION_HELP_TEXT, 
                                 FIELD_OPTION_MAX_LENGTH, FIELD_OPTION_NULL, 
                                 FIELD_OPTION_RELATED_NAME, FIELD_OPTION_UNIQUE,
                                 FIELD_OPTION_VERBOSE_NAME])
